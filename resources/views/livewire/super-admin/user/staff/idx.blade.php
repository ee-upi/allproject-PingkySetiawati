<div>
    <x-card title="Super Admin | Staff Management" shadow separator>
        ...
        <br>
        <x-table :headers="$headers" :rows="$staffs" wire:model="expanded" with-pagination no-headers expandable>
